...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 bg-bg-surface rounded-lg border border-border-default',
        'shadow-xl duration-200',
        // Mobile: full screen bottom sheet
        'bottom-0 left-0 right-0 rounded-b-none max-h-[90vh] overflow-y-auto',
        // Desktop: centered card
        'md:top-1/2 md:left-1/2 md:bottom-auto md:-translate-x-1/2 md:-translate-y-1/2',
        'md:w-full md:max-w-[560px] md:rounded-lg',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
